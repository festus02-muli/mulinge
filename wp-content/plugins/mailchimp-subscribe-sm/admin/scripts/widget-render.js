...
function formBuilderWidgetRender(this_widget, j, this_column, rowID, this_column_type ){
  ...
  jQuery.each(widgetPbFbFormFeilds, function(index, val){
    ...
    if (val['fbFieldType'] == 'hidden') {
      ...
      pbThisFormFieldWrapped =  '<div class="formFieldContainer" style=" '+hiddenField+' width:'+(thisFieldOptions['fbFieldWidth']-parseInt(formBuilderFieldHGap) )+'%; margin-right:'+formBuilderFieldHGap+'%; margin-top:'+formBuilderFieldVGap+'%; display:inline-block;">' + pbThisFormFieldLabel+'\n <br> '+pbThisFormField +'</div>';
  ...
  pbFormBuilderSubmit = greCaptchaFieldRender + 
    '<div class="formFieldContainer" style="text-align:'+widgetPbFbFormSubmitOptions['formBuilderBtnAlignment']+';  width:'+(widgetPbFbFormSubmitOptions['formBuilderBtnWidth']-parseInt(formBuilderBtnHGap) )+'%; margin:'+buttonMargin+'; margin-right:'+formBuilderBtnHGap+'%; margin-top:'+formBuilderBtnVGap+'%;  display:inline-block;"> '+
...
function completeWidgetRender(this_column_widgets_array_C, j, this_column, rowID, thisColFontsToLoad){
  ...
  //var t0 = performance.now();
         ...
         var  currWidgetResponsiveTriggerScripts = '\n' + currWidgetmarginDefault +'\n' + currWidgetmarginTablet +'\n' + currWidgetmarginMobile + '\n' + thisWidgHoverStyleTag + '\n' + widgetWidthResponsive ;
          ...
          var this_widget_styles = "margin:"+widgetMtop+"% "+widgetMright+"% "+widgetMbottom+"% "+widgetMleft+"%; "+this_widget_paddings+" "+widgBackgroundOptions+"  "+this_widget_border_shadow+" display:"+displayWigetInline+";  "+widgetStyling+" " +widgetWidth;
