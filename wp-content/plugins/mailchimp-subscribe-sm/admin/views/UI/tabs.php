...
if ( is_plugin_active( 'PluginOps-Optin-Builder-Extensions-Pack/extension-pack.php' ) || is_plugin_active( 'PluginOps-Extensions-Pack/extension-pack.php' ) ) {
  ...
  $goProLink = '<a href="https://pluginops.com/optin-builder/?ref=Optin_editorBar" target="_blank" ><div class="goProButton">Want More Features ?</div></a>';
}
...
<div class="pluginops-tabs">
  ...
  <div class="pluginops-tab-content pb_editor_tab_content" style="overflow: hidden; ">
    <div id="tab1" class="pluginops-tab pluginops-active" style="margin: 0 auto !important;">
      ...
      <div id="top-optionsBar">
        ...
        <div class="topOptionBarDivider"  style="width: 15%;">
          <div class="draftBtn">Save Draft</div>
          <div class="publishBtn">Publish</div>
        </div>
    ...
    <div id="tab4" class="pluginops-tab" style="background: #fff;">
        <?php include(SMFB_PLUGIN_PATH.'admin/views/UI/tabs/widget-form-subs-list.php'); ?>    
    </div>
