    ...
    <div class="edit_options_left_row">
      <div class="tabs colEditTabs">
        <ul class="tab-links" style="background: #2fa8f9;">
          ...
          <li style="margin: 0;"><a style="font-size:12px; padding: 10px; text-align: center;" href="#tabColumnWidgetArea" class="tab_link thisColumnWidgetsTab"> <i class="fa fa-puzzle-piece thisColumnWidgetsTab" style="font-size: 20px;"></i> <br> Column Widgets</a></li>
        </ul>
...
<script>
  ( function( $ ) {
    ...
    $('.prem-widget').each( function(index, el) {
      
      var thisPremWidgetText = $(this).html();

      $(this).html(thisPremWidgetText + '<p>Pro Only</p>');
...
<style type="text/css">
  div[data-type="wigt-pb-poOptins"], div[data-type="wigt-menu"] {
