...
<div class="tabs" style="width: 107%;">
  <ul class="tab-links">
    <li class="active"><a href="#cardf1" class="tab_link">Icon & Text</a></li>
    <li><a href="#cardf2" class="tab_link">Styling</a></li>
  </ul>
<div class="tab-content" style="box-shadow:none;">
	...
	<div id="cardf2" class="tab" style="background: #fff; padding:20px 10px 20px 25px; width: 99%;">
		<h3>Icon</h3>
		<br>
