...
<div class="tab-content" style="box-shadow:none;">
    <div id="cf1" class="tab active" style="background: #fff; padding:20px 10px 20px 25px; width: 99%;">
        ...
        <select class="pbCountDownTimezone">
        ...
        <br><br><hr><br>
        <div id="evergreenCountdown" style="display: none;">
            <label>Days : </label>
            <input type="number" class="pbCountDownDateDays">
            <br><br><hr><br>
            <label>Hours : </label>
            <input type="number" class="pbCountDownDateHours">
            <br><br><hr><br>
            <label>Minutes : </label>
            <input type="number" class="pbCountDownDateMins">
            <br><br><hr><br>
            <label>Seconds : </label>
            <input type="number" class="pbCountDownDateSecs">
            <br><br><hr><br>
        </div>
        ...
        <input type="text" class="daysText">
        <br><br><hr><br>
        <label>Hours Text </label>
        <input type="text" class="hoursText">
        <br><br><hr><br>
        <label>Minutes Text </label>
        <input type="text" class="minutesText">
        <br><br><hr><br>
        <label>Seconds Text </label>
        <input type="text" class="secondsText">
        <br><br><hr><br>
        <label>Hide Days : </label>
        <select class="hideDays">
            <option value="inline-block">No</option>
            <option value="none">Yes</option>
        </select>
        <br><br><hr><br>
        <label>Hide Hours : </label>
        <select class="hideHours">
            <option value="inline-block">No</option>
            <option value="none">Yes</option>
        </select>
        <br><br><hr><br>
        <label>Hide Minutes : </label>
        <select class="hideMinutes">
            <option value="inline-block">No</option>
            <option value="none">Yes</option>
        </select>
        <br><br><hr><br>
        <label>Hide Seconds : </label>
        <select class="hideSeconds">
            <option value="inline-block">No</option>
            <option value="none">Yes</option>
        </select>
        <br><br><hr><br>
    ...
    <div id="cf2" class="tab" style="background: #fff; padding:20px 10px 20px 25px; width: 99%;">
        ...
        <input type="text" class="color-picker_btn_two pbCountDownNumberBgColor" id="pbCountDownNumberBgColor" value='transparent' data-alpha='true'>
        <br><br><hr><br>
        <div>
            <h4>Number Font Size 
        ...
        <div>
            ...
            <div class="responsiveOps responsiveOptionsContainterLarge">
                <label></label>
                <input type="number" class="pbCountDownHGap">%
            </div>
            <div class="responsiveOps responsiveOptionsContainterMedium" style="display: none;">
                <label></label>
                <input type="number" class="pbCountDownHGapTablet">%
            </div>
            <div class="responsiveOps responsiveOptionsContainterSmall" style="display: none;">
                <label></label>
                <input type="number" class="pbCountDownHGapMobile">%
            </div>
        </div>
        <br><br><hr><br>
        <div>
            ...
            <div class="responsiveOps responsiveOptionsContainterLarge">
                <label></label>
                <input type="number" class="pbCountDownVGap">px
            </div>
            <div class="responsiveOps responsiveOptionsContainterMedium" style="display: none;">
                <label></label>
                <input type="number" class="pbCountDownVGapTablet">px
            </div>
            <div class="responsiveOps responsiveOptionsContainterSmall" style="display: none;">
                <label></label>
                <input type="number" class="pbCountDownVGapMobile">px
            </div>
        </div>
        <br><br><hr><br>
