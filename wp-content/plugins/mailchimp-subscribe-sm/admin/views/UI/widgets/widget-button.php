                  ...
                  <div class="tab-content" style="box-shadow:none;">
                    <div id="btntab1" class="tab active">
                      <div id="btn-gen" class="pbp_form" style="margin:0 0 0 0; background: #fff; padding:20px 10px 20px 25px; width: 99%;">
                        ...
                        <input type="text" class="btnText" style="width: 250px;" placeholder="Button Text" data-optname="btnText">
                        ...
                        <div class="btnLinkOpsContainer">
                          ...
                          <input type="URL" class="btnLink" placeholder="Link URL" data-optname="btnLink">
                          <br><br><hr><br>
                          ...
                          <input type="text" class="btnCAction" style="width: 250px;" placeholder="Button Actions" data-optname="btnCAction">
                          <br><br><br><br><hr><br>
                        </div>
