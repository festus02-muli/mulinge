...
<div class="tabs" style="width: 107%;">
  <ul class="tab-links">
    <li class="active"><a href="#progressBartab1" class="tab_link">Bar Options</a></li>
    <li><a href="#progressBartab2" class="tab_link">Style</a></li>
  </ul>
<div class="tab-content" style="box-shadow:none;">
	<div id="progressBartab1" class="tab active" style="background: #fff; padding:20px 10px 20px 25px; width: 99%;">
	    <br>
		<br>
        <label>Title : </label>
	...
	<div id="progressBartab2" class="tab" style="background: #fff; padding:20px 10px 20px 25px; width: 99%;">
		<br>
        <h4>Colors</h4>
