        ...
        jQuery('.sliderImageSlidesContainer').append(
            '<li> '+
                ...
                '<div class="accordContentHolder"> <br><br> '+
                    ...
                    '<input id="image_location'+slideCountA+'" type="text" class="slideImgURL upload_image_button'+slideCountA+'" name="lpp_add_img_'+slideCountA+'" value="" placeholder="Insert Image URL here" style="width:40%;" data-optname="pbSliderImagesURL.'+index+'"> '+
