...
if ( is_plugin_active('PluginOps-Optin-Builder-Extensions-Pack/extension-pack.php') || is_plugin_active('PluginOps-Optin-Builder-Extensions-Pack/extension-pack.php') ) {
        ...
        <div class="pbp_form" style="background: #fff; padding:20px 10px 20px 25px; width: 99%;" >
            ...
            <?php  
                if (function_exists('smfb_prem_extension_integrations_form_builder')) {
                    smfb_prem_extension_integrations_form_builder( $mailPoetLists );               
                } else if (function_exists('ulpb_prem_extension_integrations_form_builder')) {
                    ...
                    <div class="PB_accordion" style="width:90% !important;">
                        ...
                        <div class="pbp_form"> 
                            ...
                            <select class="formBuilderEnableMailChimp" data-optname="widgetPbFbFormMailChimp.formBuilderEnableMailChimp" >
                                <option value="">Select</option>
                                <option value="false">No</option>
                                <option value="true">Yes</option>
                            </select>
                            <br><br><br><br><hr><br>
                            <label>List ID</label>
                            <input type="text" class="formBuilderMCAccountName" style="width: 200px;" data-optname="widgetPbFbFormMailChimp.formBuilderMCAccountName" >
                            <br><br><br><br><br><hr><br>
                            <label>API Key</label>
                            <input type="text" class="formBuilderMCApiKey" style="width: 200px;" data-optname="widgetPbFbFormMailChimp.formBuilderMCApiKey" >
                            <br><br><br><br><hr><br>
                            <label>Double Optin</label>
                            <select class="formBuilderMCDoubleOptin" data-optname="widgetPbFbFormMailChimp.formBuilderMCDoubleOptin" >
                                <option value="">Select</option>
                            ...
                            <br><br><br><br><hr><br>
                            <label>Tags </label>
                            <input type="text" class="formBuilderMCTags" data-optname="widgetPbFbFormMailChimp.formBuilderMCTags" >
                            <br><br><br>
                            <p style="font-size:14px;"><i>Note :</i> Comma Separated Values. </p>
                            <hr><br>
                            <div>
                                <div class="mcgrpsContainer" style="display:none;">
                                    <label> Select A Group </label>
                                    <select class="formBuilderMCGroups" data-optname="widgetPbFbFormMailChimp.formBuilderMCGroups" >
                        ...
                        <div class="pbp_form" style="background: #fff; padding:20px 10px 20px 25px; width: 99%;">
                            ...
                            <br>
                            <br>
                            <p style="font-size:14px;"><i>Note :</i> Enter a valid email address. e.g : email@yourdomain.com </p>
                            <hr>
                            <br>
    ...
    <div id="formBuilderTab_cf6" class="tab">
        <div class="PB_accordion" style="width:100% !important;">
            ...
            <div class="pbp_form" style="background: #fff; padding:20px 10px 20px 25px; width: 99%;" >
                ...
                <select class="onSuccessOptin" data-optname="widgetPbFbFormEmailOptions.onSuccessOptin">
                    <option value="">None</option>
                    <?php
                    $FB_ULPB_args = array(
