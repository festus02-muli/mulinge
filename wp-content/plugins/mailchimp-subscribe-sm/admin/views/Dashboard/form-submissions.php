...
if (function_exists('ulpb_available_pro_widgets') || function_exists('smfb_available_pro_widgets') ) {
	...
	<div  class="abTestNotice" style=""> 
	    ...
	    <a href='https://pluginops.com/optin-builder/?ref=formSubmissions' target='_blank' style="padding: 5px 10px;"> Click here to order</a>
	</div>
	<?php
}
	...
	if (function_exists('smfb_formBuilder_database_renderFormDataTable_extension')) {
		...
		echo 
			...
			"<div style='background:#fff; margin:25px 50px; padding:5px; border-radius:7px;'>".
				...
				smfb_formBuilder_database_renderFormDataTable_extension($postId).
