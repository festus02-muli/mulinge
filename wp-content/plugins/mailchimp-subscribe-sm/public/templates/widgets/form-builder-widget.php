...
if ( ! defined( 'ABSPATH' ) ) exit; 
  ...
  if (isset($widgetPbFbFormSubmitOptions['formBuilderBtnVGap']) || isset($widgetPbFbFormSubmitOptions['formBuilderBtnHGap']) ) {
  ...
  if (isset($widgetPbFbFormSubmitOptions['formBuilderbtnSelectedIcon'])) {
    ...
    $formBuilderbtnIconAnimation = esc_attr($widgetPbFbFormSubmitOptions['formBuilderbtnIconAnimation']);
    $formBuilderbtnIconGap = esc_attr($widgetPbFbFormSubmitOptions['formBuilderbtnIconGap']);
    if ($formBuilderbtnSelectedIcon != '') {
      ...
      $formBuilderbtnIcon = '<i style="'.$formBuilderbtnIconGap.'" class="'.$faClassAppend.' '.esc_attr($formBuilderbtnSelectedIcon).'  btnIcon-'.$pbFormBuilderUniqueId.'"></i>';
  ...
  foreach($widgetPbFbFormFeilds as $widgetPbFbFormFeild){
    ...
    if ($thisFieldName == '') {
      $thisFieldName = esc_attr($widgetPbFbFormFeild['fbFieldType']);
    }
    ...
    switch ($widgetPbFbFormFeild['fbFieldType']) {
      case 'textarea':
           $pbThisFormField = '<textarea rows="'.esc_attr($thisFieldOptions['fbtextareaRows']).'" name="field-'.$widgetPbFbFormFeildsIndex.'-'.$thisFieldName.'" '.$thisFieldAttr.' class="pbFormField  '.$isfbFieldRequired.'  '.$formBuilderFieldSize.'" ></textarea>';
      break;
      case 'radio':
      ...
      case 'select':
           ...
           for ($pb_widget_form_loopi =0; $pb_widget_form_loopi< count($multiOptionFieldValues); $pb_widget_form_loopi++) {
             ...
             $thisRadioItem = '<option  value="'.esc_attr($multiOptionFieldValues[$pb_widget_form_loopi]).'" > '.esc_attr($multiOptionFieldValues[$pb_widget_form_loopi]).' </option> ';
    ...
    $pbThisFormFieldWrapped =  '<div class="pluginops_form_inp_wrapper" style=" '.$hiddenField.' width:'.( esc_attr($thisFieldOptions['fbFieldWidth'])-(int)$formBuilderFieldHGap  ).'%; margin-right:'.$formBuilderFieldHGap.'%; margin-top:'.$formBuilderFieldVGap.'%; display:inline-block;">' . $pbThisFormFieldLabel.' <br> '.$pbThisFormField .'</div>';
  ...
  $pbFormBuilderSubmitStyles = ' style=" width:100%; background:'.esc_attr($widgetPbFbFormSubmitOptions['formBuilderBtnBgColor']).' !important; color:'.esc_attr($widgetPbFbFormSubmitOptions['formBuilderBtnColor']).' !important; font-size:'.esc_attr($widgetPbFbFormSubmitOptions['formBuilderBtnFontSize']).'px;  border:'.esc_attr($widgetPbFbFormSubmitOptions['formBuilderBtnBorderWidth']).'px solid '.esc_attr($widgetPbFbFormSubmitOptions['formBuilderBtnBorderColor']).' !important; border-radius:'.esc_attr($widgetPbFbFormSubmitOptions['formBuilderBtnBorderRadius']).'px !important; font-family:'.str_replace('+', ' ', esc_attr($widgetPbFbFormSubmitOptions['formBuilderBtnFontFamily']) ).', sans-serif !important; " ';

  $pbFormBuilderSubmit = '<div class="pluginops_form_inp_wrapper" style="text-align:'.esc_attr($widgetPbFbFormSubmitOptions['formBuilderBtnAlignment']).'; width:'.(esc_attr($widgetPbFbFormSubmitOptions['formBuilderBtnWidth'])- (int)$formBuilderBtnHGap ).'%;  margin:'.$buttonMargin.';  margin-right:'.$formBuilderBtnHGap.'%; margin-top:'.$formBuilderBtnVGap.'%; display:inline-block;">  <button type="submit" '.$pbFormBuilderSubmitStyles.' class="pbField-'.$widgetPbFbFormSubmitOptions['formBuilderBtnSize'].' form-btn-'.$pbFormBuilderUniqueId.' ">'.$formBuilderbtnIconBefore.' '.$widgetPbFbFormSubmitOptions['formBuilderBtnText'].' '.$formBuilderbtnIconAfter.' </button> </div>';
  ...
  $pbFormBuilderWrapper = '<form id="'.$pbFormBuilderUniqueId.'" action="'.admin_url('admin-ajax.php?action=smfb_formBuilderEmail_ajax').'"  method="post"  > '.$pbFormAllFields.'  '.$pbFormBuilderExtraFields.'  '.wp_nonce_field('POPB_send_form_data','POPB_Form_Nonce',true,false). ' '. $pbFormBuilderSubmit.' </form>';
  ...
  $pbThisFormBuilderStyles = '<style>
    ...
    '.$pbFormBuilderStylesID.' .pbFormField {
        background:'.$widgetPbFbFormFeildOptions['formBuilderFieldBgColor'].' !important;  color:'.$widgetPbFbFormFeildOptions['formBuilderFieldColor'].' !important; border:'.$widgetPbFbFormFeildOptions['formBuilderFieldBorderWidth'].'px solid '.$widgetPbFbFormFeildOptions['formBuilderFieldBorderColor'].' !important; border-radius:'.$widgetPbFbFormFeildOptions['formBuilderFieldBorderRadius'].'px !important; font-family:'.str_replace('+', ' ', $widgetPbFbFormFeildOptions['formBuilderFieldFontFamily'] ).', sans-serif !important;
      }
      '.$pbFormBuilderStylesID.' .pbFormField::placeholder {
        color:'.$widgetPbFbFormFeildOptions['formBuilderFieldColor'].' !important;
      }

    '.$pbFormBuilderStylesID.' .pbFormLabel{
      font-size:'.$widgetPbFbFormFeildOptions['formBuilderLabelSize'].'px;
      font-family:'.str_replace('+', ' ', $widgetPbFbFormFeildOptions['formBuilderFieldFontFamily'] ).', sans-serif !important;
      color:'.$widgetPbFbFormFeildOptions['formBuilderLabelColor'].' !important; 
      display:'.$widgetPbFbFormFeildOptions['formBuilderFieldLabelDisplay'].' !important; 
      line-height:3em;
    }
  ...
  <script>
    (function($){
      ...
      $('#'+'<?php echo $pbFormBuilderUniqueId; ?>').on('submit', function()  {
        ...
        var successMessage = "<?php echo esc_attr($widgetPbFbFormEmailOptions['formSuccessMessage']); ?>";
        var errorMessage = "<?php echo esc_attr($widgetPbFbFormEmailOptions['formFailureMessage']); ?>";
            ...
            success: function(result){
              ...
              $('<?php echo ".pb_unfilled_required_field_".$pbFormBuilderUniqueId; ?>').css('display','none');
                ...
                if (calculatedResponse['isAllSuccess'] == true ) {
                  ...
                  $.cookie("pluginops_user_subscribed_form<?php echo $current_pageID; ?>", 'yes', {path: '/', expires : <?php echo $cookieConversionTime; ?> });
                  ...
                  setTimeout(function(){
                    ...
                    if ($widgetPbFbFormEmailOptions['onSuccessOptin'] != '') {
  ...
  $pb_On_complete_messages = '<div class="w3-panel w3-green pb_success" style="display:none;  width:'.(100 - (int)$formBuilderBtnHGap ).'%;  margin-right:'.$formBuilderBtnHGap.'%; "> <p>You have subscribed successfully!</p> </div>
  <div class="w3-panel w3-red pb_error" style="display:none;"><p> Some error occured</p></div>  <div class="w3-panel w3-orange pb_duplicate" style="display:none;"><p></p></div>

  <div class="w3-panel w3-orange pb_unfilled_required_field_'.$pbFormBuilderUniqueId.'" style="display:none;"><p> '.esc_attr($widgetPbFbFormEmailOptions['formRequiredFieldMessage']).' </p></div>
  ';
