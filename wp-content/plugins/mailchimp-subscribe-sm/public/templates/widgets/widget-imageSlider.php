...
$pbSliderPause = $widget_imageSlider['pbSliderPause'];
  ...
  foreach ($pbSliderImagesURL as $index => $val) {
      ...
      $pbSliderThisSlide = "<li> <div class='popb_slideContainer' style='background:url(".esc_url($slideImageUrl)."); width: 100%;height:".esc_attr($pbSliderHeight).esc_attr($pbSliderHeightUnit).";background-size: cover; background-repeat: no-repeat;background-position: center;'> ".$imageSlideContent."  </div> </li>";

      $pbSliderThisSlideAutoHeight = "<li> <div class='popb_slideContainer' style='width: 100%;height:".esc_attr($pbSliderHeight).esc_attr($pbSliderHeightUnit).";'>
  ...
  $pbSliderScript = "
    ...
    jQuery(function() {
      ...
      jQuery('#".$pbImageSliderUniqueId."').responsiveSlides({  auto:  ".$pbSliderAuto.",  speed: 500,             timeout:  ".$pbSliderDelay.",  pager:  ".$pbSliderPager.",            nav:  ".$pbSliderNav.",               random:  ".$pbSliderRandom.",            pause:  ".$pbSliderPause.",        namespace: 'pb-centeredSlider',  });
