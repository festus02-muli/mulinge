<?php if ( ! defined( 'ABSPATH' ) ) exit;
  ...
  $isPremUserPluginOps = false; 
  if (function_exists('smfb_available_pro_widgets') ) {
    $isPremUserPluginOps = true;
  }
      ...
      for ($j = 0; $j < count($colWidgets); $j++) {  // widgets loop
          ...
          switch ($this_column_type) {
            ...
            case 'wigt-img':
              ...
              if ($this_widget_img_content['iwbs'] == '') {
                $this_widget_img_content['iwbs'] = 'none';
              }
              ...
              if ($imgSize == 'custom') {
                  ...
                  $imgCustomSize = 'width:'.esc_attr($imgSizeCustomWidth).'px; height:'.esc_url($imgSizeCustomHeight).'px;';
              }
            ...
            case 'wigt-btn-gen':
              ...
              if (isset($this_widget_btn_content['btnBlankAttr'])) {
                $btnBlankAttr = esc_attr($this_widget_btn_content['btnBlankAttr']);
              }else{
                $btnBlankAttr = '';
              }
              if (isset($this_widget_btn_content['btnWidth'])) {
                $btnWidth = esc_attr($this_widget_btn_content['btnWidth']);
              }else{
                $btnWidth = '5';
              }

              if (isset($this_widget_btn_content['btnButtonFontFamily'])) {
                $btnButtonFontFamily = esc_attr($this_widget_btn_content['btnButtonFontFamily']);
              }else{
                $btnButtonFontFamily = '';
              }
              ...
              if (isset($this_widget_btn_content['btnSelectedIcon']) ) {
                ...
                if ($btnSelectedIcon != '') {
                  ...
                  $btnIcon = '<i style="'.$btnIconGap.'" class="'.$faClassAppend.' '.esc_attr($btnSelectedIcon).'  btnIcon-'.$randomBtnClass.'"></i>';
            ...
            break;
              ...
              case 'wigt-pb-postSlider':
                ...
                include SMFB_PLUGIN_PATH.'/public/templates/widgets/widget-postslider.php';
              ...
              case 'wigt-pb-icons':
                ...
                if (isset($this_widget_widgetIcons['pbIconLink']) && !empty($this_widget_widgetIcons['pbIconLink'])) {
                  ...
                  $pbIconLinkHTMl = '<a href='.esc_url($pbIconLink).' style="text-decoration:none; ">';
              ...
              case 'wigt-pb-counter':
                ...
                //if (! $isPremUserPluginOps != true ) { $widgetContent = "$premWidgetNotice"; }
              break;
            case 'wigt-pb-audio':
            ...
            case 'wigt-pb-testimonial':
              ...
              $tsUserImg = esc_url($this_widget_testimonial['tsUserImg']);
              $tsImageShape = esc_attr($this_widget_testimonial['tsImageShape']);
              $tsIconColor = esc_attr($this_widget_testimonial['tsIconColor']);
              $tsIconSize = esc_attr($this_widget_testimonial['tsIconSize']);
              $tsTextColor = esc_attr($this_widget_testimonial['tsTextColor']);
              $tsTextSize = esc_attr($this_widget_testimonial['tsTextSize']);
              $tsTestimonialColor = esc_attr($this_widget_testimonial['tsTestimonialColor']);
              $tsTestimonialSize = esc_attr($this_widget_testimonial['tsTestimonialSize']);
              $tsTextAlignment = esc_attr($this_widget_testimonial['tsTextAlignment']);
              ...
              if ($tsUserImg !== '') {
                $imgHTMLCenter = '<img src='.$tsUserImg.' style="width:25%; border-radius:'.$tsImageShape.';"   alt="'.esc_attr($this_widget_testimonial['tsIa']).'" title="'.esc_attr($this_widget_testimonial['tsIt']).'"  />';
                $imgHTMLLeft = '<img src='.$tsUserImg.' style="width:75%; border-radius:'.$tsImageShape.';"    alt="'.esc_attr($this_widget_testimonial['tsIa']).'" title="'.esc_attr($this_widget_testimonial['tsIt']).'"  />';
                $imgArea = 'visible';
              } else{
            ...
            case 'wigt-pb-imageSlider':
              include(SMFB_PLUGIN_PATH.'public/templates/widgets/widget-imageSlider.php');
              //if (! $isPremUserPluginOps != true ) { $widgetContent = "$premWidgetNotice"; }
            break;
            ...
            case 'wigt-pb-pricing':
              ...
              $this_btn_click_detectionScript = "
                ...
                ";
              $this_widget_btn = "<br>
                <div class='wdt-$this_column_type parent-btn-$randomBtnClass' style='text-align:$btnAllignment;'><a href='".esc_url($btnLink)."' style='text-decoration:none !important;' target='$btnBlankAttr' id='btnLink-$randomBtnClass'> <button class='btn-$randomBtnClass' style='color:$btnTextColor ;font-size:$btnFontSize"."px ; background: $btnBgColor ; background-color: $btnBgColor;  $POPB_buton_width  border: $btnBorderWidth"."px solid $btnBorderColor !important; border-radius: $btnBorderRadius"."px !important; text-align:center; font-family:".str_replace('+', ' ', $btnButtonFontFamily)." ,sans-serif;'>$btnIconBefore $btnText  $btnIconAfter</button></a></div> $this_btn_click_detectionScript
                ";
            ...
            case 'wigt-pb-wooCommerceProducts':
              ...
              case 'wigt-pb-formBuilder':
                ...
                include(SMFB_PLUGIN_PATH.'public/templates/widgets/form-builder-widget.php');
              ...
              case 'wigt-pb-testimonialCarousel':
                include(SMFB_PLUGIN_PATH.'public/templates/widgets/widget-testimonialCarousel.php');
                //if (! $isPremUserPluginOps != true ) { $widgetContent = "$premWidgetNotice"; }
              break;
              ...
              case 'wigt-pb-navmenu':
                ...
                foreach ($allNavItems as $key => $val) {
                  $thisMenuLink = '<a href="'.esc_url($val['cniurl']).'" >'.$val['cnilab'].'</a>';
                ...
                $logoImg = "<div class='navNlogoContainer' style='align-items: center; display: flex; justify-content: center; '>". $logoImg.$responsiveMenuSwitch .'   </div>';
                 ...
                 $customStyles = "<style>  ".
                  ...
                  #".$pbCustomId." .cMenuLogoContainer img { max-width:300px; }
                  ...
                  @media screen and (max-width: 480px) {
                    ...
                    #".$pbCustomId." { align-items: unset !important; display: unset !important; justify-content: unset !important;  text-align: center; }

                    #".$pbCustomId." .menuItemListContainer {width:100%;}

                  }
                  ".
                "</style>   <link rel='stylesheet' href='https://fonts.googleapis.com/css?family=".esc_attr($allNavStyles['cnsff'])."'> ";
              ...
              case 'wigt-pb-gallery':
                ...
                include(SMFB_PLUGIN_PATH.'public/templates/widgets/image-gallery-widget.php');

              break;
              case 'wigt-pb-accordion':

                include(SMFB_PLUGIN_PATH.'public/templates/widgets/accordion-widget.php');

              break;
              case 'wigt-pb-tabs':

                include(SMFB_PLUGIN_PATH.'public/templates/widgets/widget-tabs.php');
         ...
         /// $columnContentOld = 
          ...
          echo "
          jQuery('#".$row["rowID"]."-$Columni > .widget-$j' ).addClass('$widgetAnimation');
          jQuery(window).scroll(function(event) { 
